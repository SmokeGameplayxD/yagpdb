...
type CommandsChannelsOverride struct {
	...
	ChannelIds         types.Int64Array `boil:"channel_ids" json:"channel_ids" toml:"channel_ids" yaml:"channel_ids"`
	IsGlobal           bool             `boil:"is_global" json:"is_global" toml:"is_global" yaml:"is_global"`
	OverrideEnabled    bool             `boil:"override_enabled" json:"override_enabled" toml:"override_enabled" yaml:"override_enabled"`
	HideCMDDisabledMSG bool             `boil:"hide_cmd_disabled_msg" json:"hide_cmd_disabled_msg" toml:"hide_cmd_disabled_msg" yaml:"hide_cmd_disabled_msg"`
	ReqRoleNewCMDS     types.Int64Array `boil:"req_role_new_cmds" json:"req_role_new_cmds" toml:"req_role_new_cmds" yaml:"req_role_new_cmds"`
	DisableNewCMDS     bool             `boil:"disable_new_cmds" json:"disable_new_cmds" toml:"disable_new_cmds" yaml:"disable_new_cmds"`
	AutodeleteNewCMDS  bool             `boil:"autodelete_new_cmds" json:"autodelete_new_cmds" toml:"autodelete_new_cmds" yaml:"autodelete_new_cmds"`
...
var CommandsChannelsOverrideColumns = struct {
	...
	HideCMDDisabledMSG string
	ReqRoleNewCMDS     string
	DisableNewCMDS     string
	AutodeleteNewCMDS  string
}{
	ID:                 "id",
	GuildID:            "guild_id",
	...
	HideCMDDisabledMSG: "hide_cmd_disabled_msg",
	ReqRoleNewCMDS:     "req_role_new_cmds",
	DisableNewCMDS:     "disable_new_cmds",
	AutodeleteNewCMDS:  "autodelete_new_cmds",
}

// commandsChannelsOverrideR is where relationships are stored.
type commandsChannelsOverrideR struct {
	ChannelsOverrideCommandsChannelsCMDOverrides CommandsChannelsCMDOverrideSlice
}
...
var (
	commandsChannelsOverrideColumns               = []string{"id", "guild_id", "channel_ids", "is_global", "override_enabled", "hide_cmd_disabled_msg", "req_role_new_cmds", "disable_new_cmds", "autodelete_new_cmds"}
	commandsChannelsOverrideColumnsWithoutDefault = []string{"guild_id", "channel_ids", "is_global", "override_enabled", "hide_cmd_disabled_msg", "req_role_new_cmds", "disable_new_cmds", "autodelete_new_cmds"}
...
// ChannelsOverrideCommandsChannelsCMDOverridesG retrieves all the commands_channels_cmd_override's commands channels cmd overrides via channels_overrides_id column.
func (o *CommandsChannelsOverride) ChannelsOverrideCommandsChannelsCMDOverridesG(mods ...qm.QueryMod) commandsChannelsCMDOverrideQuery {
	return o.ChannelsOverrideCommandsChannelsCMDOverrides(boil.GetDB(), mods...)
}

// ChannelsOverrideCommandsChannelsCMDOverrides retrieves all the commands_channels_cmd_override's commands channels cmd overrides with an executor via channels_overrides_id column.
func (o *CommandsChannelsOverride) ChannelsOverrideCommandsChannelsCMDOverrides(exec boil.Executor, mods ...qm.QueryMod) commandsChannelsCMDOverrideQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"commands_channels_cmd_overrides\".\"channels_overrides_id\"=?", o.ID),
	)

	query := CommandsChannelsCMDOverrides(exec, queryMods...)
	queries.SetFrom(query.Query, "\"commands_channels_cmd_overrides\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"commands_channels_cmd_overrides\".*"})
	}

	return query
}

// LoadChannelsOverrideCommandsChannelsCMDOverrides allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (commandsChannelsOverrideL) LoadChannelsOverrideCommandsChannelsCMDOverrides(e boil.Executor, singular bool, maybeCommandsChannelsOverride interface{}) error {
	...
	query := fmt.Sprintf(
		"select * from \"commands_channels_cmd_overrides\" where \"channels_overrides_id\" in (%s)",
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load commands_channels_cmd_overrides")
	}
	defer results.Close()

	var resultSlice []*CommandsChannelsCMDOverride
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice commands_channels_cmd_overrides")
	}

	if singular {
		object.R.ChannelsOverrideCommandsChannelsCMDOverrides = resultSlice
		return nil
	}

	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ChannelsOverridesID {
				local.R.ChannelsOverrideCommandsChannelsCMDOverrides = append(local.R.ChannelsOverrideCommandsChannelsCMDOverrides, foreign)
				break
			}
		}
	}
...
// AddChannelsOverrideCommandsChannelsCMDOverridesG adds the given related objects to the existing relationships
// of the commands_channels_override, optionally inserting them as new records.
// Appends related to o.R.ChannelsOverrideCommandsChannelsCMDOverrides.
// Sets related.R.ChannelsOverride appropriately.
// Uses the global database handle.
func (o *CommandsChannelsOverride) AddChannelsOverrideCommandsChannelsCMDOverridesG(insert bool, related ...*CommandsChannelsCMDOverride) error {
	return o.AddChannelsOverrideCommandsChannelsCMDOverrides(boil.GetDB(), insert, related...)
}

// AddChannelsOverrideCommandsChannelsCMDOverridesP adds the given related objects to the existing relationships
// of the commands_channels_override, optionally inserting them as new records.
// Appends related to o.R.ChannelsOverrideCommandsChannelsCMDOverrides.
// Sets related.R.ChannelsOverride appropriately.
// Panics on error.
func (o *CommandsChannelsOverride) AddChannelsOverrideCommandsChannelsCMDOverridesP(exec boil.Executor, insert bool, related ...*CommandsChannelsCMDOverride) {
	if err := o.AddChannelsOverrideCommandsChannelsCMDOverrides(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddChannelsOverrideCommandsChannelsCMDOverridesGP adds the given related objects to the existing relationships
// of the commands_channels_override, optionally inserting them as new records.
// Appends related to o.R.ChannelsOverrideCommandsChannelsCMDOverrides.
// Sets related.R.ChannelsOverride appropriately.
// Uses the global database handle and panics on error.
func (o *CommandsChannelsOverride) AddChannelsOverrideCommandsChannelsCMDOverridesGP(insert bool, related ...*CommandsChannelsCMDOverride) {
	if err := o.AddChannelsOverrideCommandsChannelsCMDOverrides(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddChannelsOverrideCommandsChannelsCMDOverrides adds the given related objects to the existing relationships
// of the commands_channels_override, optionally inserting them as new records.
// Appends related to o.R.ChannelsOverrideCommandsChannelsCMDOverrides.
// Sets related.R.ChannelsOverride appropriately.
func (o *CommandsChannelsOverride) AddChannelsOverrideCommandsChannelsCMDOverrides(exec boil.Executor, insert bool, related ...*CommandsChannelsCMDOverride) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ChannelsOverridesID = o.ID
	...
	if o.R == nil {
		o.R = &commandsChannelsOverrideR{
			ChannelsOverrideCommandsChannelsCMDOverrides: related,
		}
	} else {
		o.R.ChannelsOverrideCommandsChannelsCMDOverrides = append(o.R.ChannelsOverrideCommandsChannelsCMDOverrides, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &commandsChannelsCMDOverrideR{
				ChannelsOverride: o,
			}
		} else {
			rel.R.ChannelsOverride = o
		}
	}
	return nil
}
